...
class StatsTracker:
    ...
    def get_active_projects(self) -> list[str]:
        """
        Return project names with at least 1 session in the last 30 days.
        Uses a 30-day window so old abandoned projects never block FREE tier.
        Returns [] safely if no history exists yet.
        """
